...
function optionsframework_menu_settings() {
	...
	$menu = array(
		'page_title' => __( 'Coller Theme Options', 'optionsframework'),
		'menu_title' => __('Coller Settings', 'optionsframework'),
		'capability' => 'edit_theme_options',
		'menu_slug' => 'coller-options',
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Coller Settings', 'options_framework_theme' ),
			'href' => admin_url( 'themes.php?page=coller-options' )
		));
}
